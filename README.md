...
**(A)** Scatter plot showing the number of publications per human gene (n=~33,000 genes). Genes are ordered by publication count, with the most highly studied genes (>3,000 publications) labeled where space permits. Most genes have relatively few publications, while a small subset dominates the literature.

**(B)** Publication counts for genes associated with inborn errors of metabolism (n=1,766 genes, IEMbase). Green points highlight metabolic disorder genes, with the most highly studied genes (>500 publications) labeled where space permits. These disease-relevant genes show moderate to high publication rates.

**(C)** Publication counts for mitochondrial genes (n=1,136 genes, MitoCarta3.0). Red points show mitochondrial gene publication patterns, with the most highly studied genes (>500 publications) labeled where space permits. Mitochondrial genes represent a well-studied cellular compartment.
